Fallout 4 Script Extender v0.4.2
...
This version is compatible with runtime 1.9.4. You can ignore any part of the version number after those components; they're not relevant for compatibility purposes.
