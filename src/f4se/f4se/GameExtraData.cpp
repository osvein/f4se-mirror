...
RelocAddr <uintptr_t> s_ExtraPowerLinksVtbl(0x02C7C3B8);

// ??_7ExtraInstanceData@@6B@
RelocAddr <uintptr_t> s_ExtraInstanceDataVtbl(0x02C7DC40);

// ??_7ExtraHealth@@6B@
RelocAddr <uintptr_t> s_ExtraHealthVtbl(0x02C7C218);
