...
RelocPtr <INISettingCollection *> g_iniSettings(0x05E1F3E0);
RelocPtr <INIPrefSettingCollection*> g_iniPrefSettings(0x05CEE6B8);
RelocPtr <RegSettingCollection *> g_regSettings(0x062228D0);
