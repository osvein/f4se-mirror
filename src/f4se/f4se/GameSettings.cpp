...
RelocPtr <INISettingCollection *> g_iniSettings(0x05E203E0);
RelocPtr <INIPrefSettingCollection*> g_iniPrefSettings(0x05CEF6B8);
RelocPtr <RegSettingCollection *> g_regSettings(0x062238D0);
