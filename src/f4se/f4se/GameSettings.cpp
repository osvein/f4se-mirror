...
RelocPtr <INISettingCollection *> g_iniSettings(0x05B309E0);
RelocPtr <INIPrefSettingCollection*> g_iniPrefSettings(0x059FFCB8);
RelocPtr <RegSettingCollection *> g_regSettings(0x05F33ED0);
