...
RelocPtr <INISettingCollection *> g_iniSettings(0x05BC0908);
RelocPtr <INIPrefSettingCollection*> g_iniPrefSettings(0x05A8EFB8);
RelocPtr <RegSettingCollection *> g_regSettings(0x05FC4C10);
