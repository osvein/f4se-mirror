...
public:
	...
	DEFINE_MEMBER_FN(CreateBSGeometryData, BSGeometryData*, 0x01D0BB30, UInt32 * blockSize, UInt8 * vertexData, UInt64 vertexDesc, BSGeometryData::TriangleData * triData); // Creates a block with a vertex copy in the resource pool with a reference to the supplied triblock (partial deep copy)
};
...
public:
	...
	DEFINE_MEMBER_FN(LockTextureType, void, 0x01D32780, UInt32 type);
	// D16605905EE44603E286262CE17CFC8383EABDDC+32F
	DEFINE_MEMBER_FN(ReleaseTextureType, void, 0x01D32810, UInt32 type);
	DEFINE_MEMBER_FN(GetRenderData, BSRenderData *, 0x01D326E0, UInt32 type, UInt64 unk1, UInt64 unk2, UInt32 unk3); // type, 0, 1, 0
	// D16605905EE44603E286262CE17CFC8383EABDDC+1EF
	DEFINE_MEMBER_FN(Unk_01, void, 0x01D32730, UInt32 type, BSRenderData *, UInt8 unk3); // type, rendererData, 1
};
