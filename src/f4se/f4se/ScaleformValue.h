...
public:
	...
	DEFINE_MEMBER_FN(Impl_ctor, BSGFxShaderFXTarget *, 0x020EFCD0, GFxValue * source);
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x020EFC30);
	DEFINE_MEMBER_FN(Impl_Fn1, void, 0x020F0150, void * unk1, void * unk2);
};
