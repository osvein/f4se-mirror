...
RelocAddr <_SendCustomEvent> SendCustomEvent_Internal(0x013D92A0);
RelocAddr <_CallFunctionNoWait> CallFunctionNoWait_Internal(0x013D6810);
RelocAddr <_CallGlobalFunctionNoWait> CallGlobalFunctionNoWait_Internal(0x014518C0);
