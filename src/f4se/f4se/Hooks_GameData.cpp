...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00D06F50);

typedef void (* _GameDataReady_Original)(bool isReady);
// writes to g_isGameDataReady
RelocAddr <_GameDataReady_Original> GameDataReady_Original(0x00811090);
...
{
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x02BF52E8 + 8); // InitGameDataThread vtable func1
