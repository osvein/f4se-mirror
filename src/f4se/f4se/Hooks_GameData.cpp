...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00D515D0);

typedef void (* _GameDataReady_Original)(bool isReady);
// writes to g_isGameDataReady

// 936C94CC97C598DFE8A81979F95A75088F8B44C2+3AF
RelocAddr <_GameDataReady_Original> GameDataReady_Original(0x0082F8C0);
...
{
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x02D51E18 + 8); // InitGameDataThread vtable func1
