...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00D52F20);
...
{
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x02D65E98 + 8); // InitGameDataThread vtable func1
