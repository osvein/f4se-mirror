...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00D06B60);

typedef void (* _GameDataReady_Original)(bool isReady);
// writes to g_isGameDataReady
RelocAddr <_GameDataReady_Original> GameDataReady_Original(0x00811080);
