...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00D01880);

typedef void (* _GameDataReady_Original)(bool isReady);
// writes to g_isGameDataReady
RelocAddr <_GameDataReady_Original> GameDataReady_Original(0x0080EAF0);
...
{
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x02BECA38 + 8); // InitGameDataThread vtable func1
