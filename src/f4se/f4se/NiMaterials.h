...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x0276EFA0);
	DEFINE_MEMBER_FN(dtor, void, 0x0038E090);
	DEFINE_MEMBER_FN(ApplyMaterialData, void, 0x02775EC0, BSTriShape * trishape, bool unk1);
};
