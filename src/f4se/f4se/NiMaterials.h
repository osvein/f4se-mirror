...
public:
	...
	DEFINE_MEMBER_FN(Copy, void, 0x0284AB60, const BSLightingShaderMaterialBase * src);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x027E2520);
	DEFINE_MEMBER_FN(dtor, void, 0x003900D0);
	DEFINE_MEMBER_FN(ApplyMaterialData, void, 0x027E9440, BSGeometry * trishape, bool unk1);
};
