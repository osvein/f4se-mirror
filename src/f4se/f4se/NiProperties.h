...
public:
	...
	DEFINE_MEMBER_FN(SetMaterial, bool, 0x027E1280, BSShaderMaterial * material, bool unk1);
	DEFINE_MEMBER_FN(SetFlag, void, 0x027E1100, UInt8 flags, bool enabled); // sets or unsets particular flags
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x027EF7E0);
...
public:
	...
	DEFINE_MEMBER_FN(ctor, BSLightingShaderProperty *, 0x027F15A0);
	DEFINE_MEMBER_FN(MakeValidForRendering, void, 0x027F1890, BSGeometry * geometry); // previously InvalidateShader
	DEFINE_MEMBER_FN(ApplyMaterial, bool, 0x00054170); // Calls BSShaderProperty::SetMaterial
	DEFINE_MEMBER_FN(LoadTextureSet, void, 0x027F1F20, UInt32 unk1); // unk1 usually 0, called after material Releases textures (previously InvalidateTextures)
