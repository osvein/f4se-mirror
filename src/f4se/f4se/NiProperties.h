...
public:
	...
	DEFINE_MEMBER_FN(MakeValidForRendering, void, 0x026E36C0, BSGeometry * geometry); // previously InvalidateShader
	DEFINE_MEMBER_FN(ApplyMaterial, bool, 0x00053690); // Calls BSShaderProperty::SetMaterial
	DEFINE_MEMBER_FN(SetMaterial, bool, 0x026D30B0, BSShaderMaterial * material, bool unk1);
	DEFINE_MEMBER_FN(SetFlag, void, 0x026D2F30, UInt8 flags, bool enabled); // sets or unsets particular flags
	DEFINE_MEMBER_FN(LoadTextureSet, void, 0x026E3D50, UInt32 unk1); // unk1 usually 0, called after material Releases textures (previously InvalidateTextures)
};
