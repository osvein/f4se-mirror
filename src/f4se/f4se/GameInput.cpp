...
RelocPtr <InputEventTable*> g_inputEventTable(0x05994540);
RelocPtr <InputDeviceManager*> g_inputDeviceMgr(0x05994148);
RelocPtr <InputManager*> g_inputMgr(0x0590EDD0);
