...
RelocPtr <InputEventTable*> g_inputEventTable(0x05978E80);
RelocPtr <InputDeviceManager*> g_inputDeviceMgr(0x05978A88);
RelocPtr <InputManager*> g_inputMgr(0x058F3790);
