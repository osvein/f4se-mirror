...
RelocPtr <InputEventTable*> g_inputEventTable(0x0595D300);
RelocPtr <InputDeviceManager*> g_inputDeviceMgr(0x0595CF08);
RelocPtr <InputManager*> g_inputMgr(0x058D7DA0);
