...
public:
	...
	DEFINE_MEMBER_FN(Construct, BSResourceNiBinaryStream *, 0x00513280, const char * filePath, UInt8 unk1, UInt64 unk2, SInt8 unk3);	// unk1 = 0, unk2 = 0, unk3 = 0
	DEFINE_MEMBER_FN(ReadLine, UInt32, 0x01AF5180, char * dst, UInt32 dstLen, UInt32 terminator);
	DEFINE_MEMBER_FN(Destroy, void, 0x1AF5460);
	DEFINE_MEMBER_FN(IsValid, bool, 0x1AF5060, void);
	DEFINE_MEMBER_FN(Seek, void, 0x01AF5070, SInt64);
	DEFINE_MEMBER_FN(GetOffset, UInt32, 0x1AF50D0, void);
	DEFINE_MEMBER_FN(Unk_04, SInt64, 0x01AF50E0, void * unk1);
	DEFINE_MEMBER_FN(Read, UInt32, 0x01AF5240, void * buf, UInt64 length);
	DEFINE_MEMBER_FN(Write, UInt32, 0x01AF52D0, void * buf, UInt64 length);
