...
RelocPtr <PlayerCharacter*> g_player(0x05ADC3D8);
...
RelocPtr <UInt32> g_invalidRefHandle(0x03904E84);

RelocAddr <_HasDetectionLOS> HasDetectionLOS(0x0135B0E0);
...
RelocAddr <_MoveRefrToPosition> MoveRefrToPosition(0x013FE240);
