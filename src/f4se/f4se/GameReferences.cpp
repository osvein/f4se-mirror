...
RelocPtr <PlayerCharacter*> g_player(0x05ADE398);
...
RelocPtr <UInt32> g_invalidRefHandle(0x03906E84);

RelocAddr <_HasDetectionLOS> HasDetectionLOS(0x0135B020);

RelocAddr <_GetLinkedRef_Native> GetLinkedRef_Native(0x00480E80);

RelocAddr <_SetLinkedRef_Native> SetLinkedRef_Native(0x00480EA0);

RelocAddr <_MoveRefrToPosition> MoveRefrToPosition(0x013FE180);
