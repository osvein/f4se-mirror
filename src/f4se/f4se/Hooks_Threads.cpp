...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00D04D20);
...
{
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x02BFA568 + 8); // InitGameDataThread vtable func1
