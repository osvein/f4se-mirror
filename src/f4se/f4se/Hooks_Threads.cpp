...
RelocAddr <_InitGameDataThread_Run_Original> InitGameDataThread_Run_Original(0x00CFAA60);
...
{
	RelocAddr <uintptr_t> InitGameDataThread_Run(0x02BE3068 + 8); // InitGameDataThread vtable func1
