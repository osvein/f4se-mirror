...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x026FFC60);
};
...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x0272BD10);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x02704C70, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x02704620);
