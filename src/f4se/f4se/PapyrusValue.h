...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x02710E90);
};
...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x0273CF40);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x02715EA0, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x02715850);
