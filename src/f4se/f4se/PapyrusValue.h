...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x02602AC0);
};
...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x0262EB70);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x02607AD0, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x02607480);
