...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x02710E60);
};
...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x0273CF10);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x02715E70, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x02715820);
