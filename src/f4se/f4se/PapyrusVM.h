...
public:
	...
	DEFINE_MEMBER_FN(SendPapyrusEvent, void, 0x01374950, UInt64 handle, const BSFixedString & eventName, std::function<bool(void*)> functor); // Signature not correct yet
};
