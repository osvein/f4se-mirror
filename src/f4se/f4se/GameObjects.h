...
public:
	...
	DEFINE_MEMBER_FN(ctor, TESNPC*, 0x00598730);
	DEFINE_MEMBER_FN(HasOverlays, bool, 0x005A9F20);
	DEFINE_MEMBER_FN(GetOverlayHeadParts, BGSHeadPart**, 0x005AA030);
	DEFINE_MEMBER_FN(GetNumOverlayHeadParts, int, 0x005AA0C0);
	DEFINE_MEMBER_FN(GetSex, SInt64, 0x0058C9E0); // npc->actorData.unk08 & 1
	DEFINE_MEMBER_FN(ChangeHeadPartRemovePart, void, 0x0059F400, BGSHeadPart *, bool bRemoveExtraParts);
	DEFINE_MEMBER_FN(ChangeHeadPart, void, 0x005A3980, BGSHeadPart *);
