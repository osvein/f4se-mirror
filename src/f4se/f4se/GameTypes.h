...
public:
	...
	struct Ref
	{
		...
		DEFINE_MEMBER_FN(ctor, Ref *, 0x01B416E0, const char * buf);	// D3703E13297FD78BE317E0223C90DAB9021465DD+6F
		DEFINE_MEMBER_FN(ctor_w, Ref *, 0x01B42500, const wchar_t * buf); // 34CA732E6B3C7BCD20DEFC8B3711427E5285FF82+AA

		DEFINE_MEMBER_FN(Set, Ref *, 0x01B41810, const char * buf);		// 489C5F60950D108691FCB6CB0026101275BE474A+79
		DEFINE_MEMBER_FN(Set_w, Ref *, 0x01B43D60, const wchar_t * buf);

		DEFINE_MEMBER_FN(Release, void, 0x01B42970);
