...
public:
	...
	struct Ref
	{
		...
		DEFINE_MEMBER_FN(ctor, Ref *, 0x01ACFC30, const char * buf);	// D3703E13297FD78BE317E0223C90DAB9021465DD+6F
		DEFINE_MEMBER_FN(Set, Ref *, 0x01ACFD60, const char * buf);		// 489C5F60950D108691FCB6CB0026101275BE474A+79
		DEFINE_MEMBER_FN(Release, void, 0x01AD0EC0);
	...
	struct RefW
	{
		...
		DEFINE_MEMBER_FN(ctor, RefW *, 0x01AD0130, const wchar_t * buf);
