...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x02038F20);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x0201B470);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x020395C0 + 0x188);
