...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x020A8FF0);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x0208B550);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x020A9690 + 0x188);
