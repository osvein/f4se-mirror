...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x0206F780);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x02051CE0);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x0206FE20 + 0x188);
