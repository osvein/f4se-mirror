...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x02095600);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x02077B60);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x02095CA0 + 0x188);
