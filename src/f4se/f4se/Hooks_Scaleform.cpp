...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x0209C480);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x0207E9E0);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x0209CB20 + 0x188);
