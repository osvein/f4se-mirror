...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x020A8210);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x0208A770);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x020A88B0 + 0x188);
