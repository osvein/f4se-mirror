...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x0209FA30);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x02081F90);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x020A00D0 + 0x188);
