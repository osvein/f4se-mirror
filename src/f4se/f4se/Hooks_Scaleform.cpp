...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x020A9400);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x0208B960);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x020A9AA0 + 0x188);
