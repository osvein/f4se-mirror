...
RelocAddr <_BSScaleformManager_Ctor> BSScaleformManager_Ctor(0x02039110);
...
RelocAddr <_BSScaleformTint> BSScaleformTint(0x0201B660);
...
void Hooks_Scaleform_Commit()
{
	...
	{
		RelocAddr <uintptr_t> ScaleformInitHook_Start(0x020397B0 + 0x188);
