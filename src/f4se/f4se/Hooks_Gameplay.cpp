...
RelocAddr <char *> g_gameVersion(0x02B10D98);

RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00B76440 + 0x53 + 3);
RelocAddr <uintptr_t> kHook_ShowVersion_OffsetBase(0x00B76440 + 0x5A);
...
RelocAddr <uintptr_t> kHook_CustomControlMap_Offset(0x01AC3290);
RelocAddr <void *> kHook_CustomControlMap_Return(0x01AC3290 + 5);
