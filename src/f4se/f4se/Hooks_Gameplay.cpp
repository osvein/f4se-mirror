...
RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00BBC330 + 0x53 + 3);
RelocAddr <uintptr_t> kHook_ShowVersion_OffsetBase(0x00BBC330 + 0x5A);
...
RelocAddr <uintptr_t> kHook_CustomControlMap_Offset(0x01B2A050);
RelocAddr <void *> kHook_CustomControlMap_Return(0x01B2A050 + 5);
