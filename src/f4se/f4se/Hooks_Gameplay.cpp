...
RelocAddr <char *> g_gameVersion(0x02C86748);
...
RelocAddr <uintptr_t> kHook_CustomControlMap_Offset(0x01B29C30);
RelocAddr <void *> kHook_CustomControlMap_Return(0x01B29C30 + 5);
