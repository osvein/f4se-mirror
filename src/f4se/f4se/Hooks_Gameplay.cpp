...
RelocAddr <char *> g_gameVersion(0x02AA92D8);

RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00B48C20 + 0x53 + 3);
RelocAddr <uintptr_t> kHook_ShowVersion_OffsetBase(0x00B48C20 + 0x5A);
...
RelocAddr <uintptr_t> kHook_CustomControlMap_Offset(0x01A98E70);
RelocAddr <void *> kHook_CustomControlMap_Return(0x01A98E70 + 5);
