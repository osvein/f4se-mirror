...
RelocAddr <char *> g_gameVersion(0x02B11DC8);

RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00B75840 + 0x53 + 3);
RelocAddr <uintptr_t> kHook_ShowVersion_OffsetBase(0x00B75840 + 0x5A);
...
RelocAddr <uintptr_t> kHook_CustomControlMap_Offset(0x01AC28B0);
RelocAddr <void *> kHook_CustomControlMap_Return(0x01AC28B0 + 5);
