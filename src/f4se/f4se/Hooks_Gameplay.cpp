...
RelocAddr <char *> g_gameVersion(0x02C9AD68);

RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00B1CEC0 + 0x53 + 3);
RelocAddr <uintptr_t> kHook_ShowVersion_OffsetBase(0x00B1CEC0 + 0x5A);
...
RelocAddr <uintptr_t> kHook_CustomControlMap_Offset(0x01A64D40);
RelocAddr <void *> kHook_CustomControlMap_Return(0x01A64D40 + 5);
