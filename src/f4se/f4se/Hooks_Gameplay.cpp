...
RelocAddr <char *> g_gameVersion(0x037A4818);

RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00E57760 + 0x53 + 3);
RelocAddr <uintptr_t> kHook_ShowVersion_OffsetBase(0x00E57760 + 0x5A);
...
RelocAddr <uintptr_t> kHook_CustomControlMap_Offset(0x01F9D030);
RelocAddr <void *> kHook_CustomControlMap_Return(0x01F9D030 + 5);
