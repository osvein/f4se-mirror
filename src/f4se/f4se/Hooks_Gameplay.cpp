...
RelocAddr <char *> g_gameVersion(0x037A3828);

RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00E571E0 + 0x53 + 3);
RelocAddr <uintptr_t> kHook_ShowVersion_OffsetBase(0x00E571E0 + 0x5A);
