...
public:
	...
	DEFINE_MEMBER_FN(Internal_AddExtraData, bool, 0x01B6AE10, NiExtraData * extraData);
};
...
public:
	...
	DEFINE_MEMBER_FN(GetAVObjectByName, NiAVObject*, 0x01C73550, BSFixedString * name, bool unk1, bool unk2);
};
