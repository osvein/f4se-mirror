...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(dtor, void, 0x01C61180);
		DEFINE_MEMBER_FN(Impl_Process, void, 0x00136790, ModelData * modelData, const char * modelName, NiAVObject ** root, UInt32 * typeOut);
	};
};
