...
#define F4SE_VERSION_INTEGER_MINOR	4
#define F4SE_VERSION_INTEGER_BETA	1
#define F4SE_VERSION_VERSTRING		"0, 0, 4, 1"
#define F4SE_VERSION_PADDEDSTRING	"0005"
#define F4SE_VERSION_RELEASEIDX		5
...
#define CURRENT_RELEASE_F4SE_STR	"0.4.1"
